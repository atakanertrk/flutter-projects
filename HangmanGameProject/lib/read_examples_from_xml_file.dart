...
Future<Example> GetSpecifiedExample(BuildContext context, int level) async {
  String xmlString = await DefaultAssetBundle.of(context).loadString("assets/xmlfiles/bookshelf.xml");
